...
for (k in seq(from=1, to=nAssets)) {
   ...
   for (e in seq(from=1, to=nExp)) {      
      ...
      #plot(mean_ACF_returns[,(e-1)*nAssets+k], type="l", main="", ylim=c(-1,1), xlab="Lag", ylab="Autocorrelación")
...
for (k in seq(from=1, to=nAssets)) {
   ...
   for (e in seq(from=1, to=nExp)) {
      ...
      lines(mean_ACF_squaredreturns[,(e-1)*nAssets+k], type="l", col="red")

      #plot(mean_ACF_absreturns[,(e-1)*nAssets+k], type="l", main="", ylim=c(-1,1), xlab="Lag", ylab="Autocorrelación")
      lines(upper_bound, lty=2, col="blue")
      lines(lower_bound, lty=2, col="blue")      
   }
...
for (k in seq(from=1, to=nAssets)) {
   ...
   for (e in seq(from=1, to=nExp)) {
      ...
      plot(mean_ACF_squaredreturns[,(e-1)*nAssets+k], type="l", main="", ylim=c(-1,1), xlab="Lag", ylab="Autocorrelación")
      lines(upper_bound, lty=2, col="blue")
      lines(lower_bound, lty=2, col="blue")      
   }
...
plot(mean_ACF_volume[,(e-1)*nAssets+k], type="l", main="", ylim=c(-1,1), xlab="Lag", ylab="Autocorrelación")
...
plot(tsFUNDwealth_avg[,(e-1)*nAssets+k], type="l", main="", ylim=c(y_min,y_max), xlab="", ylab="", col="darkorange1")
   ...
   legend("topleft", c("Fundamentalistas","Técnicos"), lty=c(1,1), lwd=c(3,3), col=c("darkorange1", "seagreen"))
...
for (k in seq(from=1, to=nAssets)) {
   ...
   for (e in seq(from=1, to=nExp)) {
	...
	graph = ggplot(df_prop, aes(x=tick, y=Percent, fill=group)) + geom_area(position = 'stack') +
		...
		#breaks = c("FUND", "TREND", "random"), labels = c("FUND", "TREND", "Random"))
            breaks = c("FUND", "TREND", "random"), labels = c("Fundamentalistas", "Técnicos", "Aleatorio"))
