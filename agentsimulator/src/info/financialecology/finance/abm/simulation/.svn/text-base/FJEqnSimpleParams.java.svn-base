 ...
 *
 */
public class FJEqnSimpleParams extends SimulationParameters {
     ...
     * @throws FileNotFoundException 
     */
    public static FJEqnSimpleParams readParameters(String file) throws FileNotFoundException {
        return (FJEqnSimpleParams) readParams(file, new FJEqnSimpleParams());
    }
