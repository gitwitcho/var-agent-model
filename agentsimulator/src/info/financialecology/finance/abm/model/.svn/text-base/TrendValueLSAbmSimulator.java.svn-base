 ...
 *
 */
public class TrendValueLSAbmSimulator extends AbstractSimulator {
    ...
    private static final Logger logger = (Logger)LoggerFactory.getLogger(TrendValueLSAbmSimulator.class.getSimpleName());
    
    
    /**
     * Constructor. Creates the scheduler ({@link ISchedule}) and the {@link ShareMarket}.
     */
    public TrendValueLSAbmSimulator() {
     ...
     */
    public TrendValueLSAbmSimulator(String pTrend, String pValue, String pLS) {
