...
public class TestBrownianProcessParams extends SimulationParameters {
    
    private static final Logger logger = (Logger)LoggerFactory.getLogger(TestBrownianProcessParams.class.getSimpleName());
...
//            return -1;
    ...
    public Boolean validate() {
        ...
        /**
         * VALIDATE double sequences: mu, sigma 
         */
         ...
         * processes.
         */
        validated = (mu.isEmpty() && sigma.isEmpty()) ||
                      (!mu.isEmpty() && !sigma.isEmpty());
        
        Assertion.assertStrict((validated == true), Level.ERR, "Parameters for the Brownian process are not well-defined " +
    ...
    public static void writeParamDefinition(String file) throws FileNotFoundException {
        writeParamsDefinition(file, new TestBrownianProcessParams());
    }
     ...
     * @throws FileNotFoundException 
     */
    public static TestBrownianProcessParams readParameters(String file) throws FileNotFoundException {

    	TestBrownianProcessParams params = (TestBrownianProcessParams) readParams(file, new TestBrownianProcessParams());
