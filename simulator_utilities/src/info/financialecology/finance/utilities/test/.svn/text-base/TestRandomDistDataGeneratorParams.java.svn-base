...
import info.financialecology.finance.utilities.test.TestBrownianProcessParams.Sequence;
...
public class TestRandomDistDataGeneratorParams extends SimulationParameters {
    
    private static final Logger logger = (Logger)LoggerFactory.getLogger(TestRandomDistDataGeneratorParams.class.getSimpleName());
...
//            return -1;
    ...
    TestRandomDistDataGeneratorParams() {}
    ...
    public Boolean validate() {
        ...
        /**
         * VALIDATE double sequences: distParam_1, distParam_2 
         */
        ...
        /*
         * Validate Brownian process parameters. The values have 
         * to be all omitted or all provided for the Brownian process.
         *  
         * In the multi-asset case, the same validation applies to all
         * processes.
         */
        validated = (distParam_1.isEmpty() && distParam_2.isEmpty()) ||
                      (!distParam_1.isEmpty() && !distParam_2.isEmpty());
        
        Assertion.assertStrict((validated == true), Level.ERR, "Parameters for the random generator are not well-defined " +
        		"(some are provided while others are omitted)");
    ...
    public static void writeParamDefinition(String file) throws FileNotFoundException {
        writeParamsDefinition(file, new TestRandomDistDataGeneratorParams());
    }
     ...
     * @throws FileNotFoundException 
     */
    public static TestRandomDistDataGeneratorParams readParameters(String file) throws FileNotFoundException {

    	TestRandomDistDataGeneratorParams params = (TestRandomDistDataGeneratorParams) readParams(file, new TestRandomDistDataGeneratorParams());
