...
public class TestSteppedDataGeneratorParams extends SimulationParameters {
    ...
    public String shift;               // shift of the stepped function along the y-axis
    public String stepHeight;          // height of the steps along the y-axis
    public String stepWidth;           // amplitude of the steps along the x-axis
    public String valleyWidth;         // amplitude of the valleys along the x-axis
    ...
    public enum Sequence implements ParamSequence {
    	...
    	STEP_HEIGHT(Item.DOUBLE_SEQ, false),
    	STEP_WIDTH(Item.DOUBLE_SEQ, false),
    	VALLEY_WIDTH(Item.DOUBLE_SEQ, false);
...
//            return -1;
    ...
    TestSteppedDataGeneratorParams() {}
    ...
    private void initialiseSequenceParams() {
        ...
        Sequence.STEP_HEIGHT.setParamString(stepHeight);
        Sequence.STEP_WIDTH.setParamString(stepWidth);
        Sequence.VALLEY_WIDTH.setParamString(valleyWidth);
    }
    ...
    public Boolean validate() {
        ...
        validateDoubleSequence(Sequence.STEP_HEIGHT);
        validateDoubleSequence(Sequence.STEP_WIDTH);
        validateDoubleSequence(Sequence.VALLEY_WIDTH);
         ...
         */
        validated_1 = (shift.isEmpty() && stepHeight.isEmpty() && stepWidth.isEmpty() && valleyWidth.isEmpty()) ||
                      (!shift.isEmpty() && !stepHeight.isEmpty() && !stepWidth.isEmpty() && !valleyWidth.isEmpty());
        
        Assertion.assertStrict((validated_1 == true) , Level.ERR, "Parameters are not well-defined " +
        		"(some are provided while others are omitted for the stepped function)");
    ...
    public static void writeParamDefinition(String file) throws FileNotFoundException {
        writeParamsDefinition(file, new TestSteppedDataGeneratorParams());
    }
     ...
     * @throws FileNotFoundException 
     */
    public static TestSteppedDataGeneratorParams readParameters(String file) throws FileNotFoundException {

    	TestSteppedDataGeneratorParams params = (TestSteppedDataGeneratorParams) readParams(file, new TestSteppedDataGeneratorParams());
